...
     }
    ...
    var tokens = cleanText.split(/\s+/);   //remove space, tabs, newline
    //tokens.sort()
   ...
   // Step 4: Count Frequencies
    ...
    WordCloud(document.getElementById('wc_cloud_container'), {
      ...
      // gridSize: 10, // Adjust the grid size for better word cloud layout
      // weightFactor: 10, // Adjust the size of the words based on their frequencies
      ...
      // rotateRatio: 0.5, // Probability for word rotation
    });
 }
...
"your", "yours", "yourself","yourselves","classvectortoclistitem","vectortoclevel","mwparseoutput","emmwparseroutput"];
